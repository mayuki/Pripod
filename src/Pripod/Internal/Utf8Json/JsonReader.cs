...
namespace Pripod.Internal.Utf8Json
{
    ...
    internal struct JsonReader
    {
        ...
        public Single ReadSingle()
        {
            SkipWhiteSpace();
            int readCount;
            var v = Pripod.Internal.Utf8Json.Internal.DoubleConversion.StringToDoubleConverter.ToSingle(bytes, offset, out readCount);
            if (readCount == 0)
            {
                throw CreateParsingException("Number Token");
            }
        ...
        public Double ReadDouble()
        {
            SkipWhiteSpace();
            int readCount;
            var v = Pripod.Internal.Utf8Json.Internal.DoubleConversion.StringToDoubleConverter.ToDouble(bytes, offset, out readCount);
            if (readCount == 0)
            {
                throw CreateParsingException("Number Token");
            }
